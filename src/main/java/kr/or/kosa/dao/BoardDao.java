...
public interface BoardDao {
	...
	// 기본 제공 게시판 글 목록
	public List<Post> allBoardList(@Param("boardname") String boardName, @Param("universitycode") String universitycode,
			@Param("startpage") int startpage, @Param("pagepernum") int pagepernum);
