...
public class MypageFrontController {
	...
	public String myPageModifySubmit(Model model, Principal principal, @RequestParam("password") String password,
			@RequestParam("email") String email, @RequestParam("phone") String phone,
			@RequestParam("parentsPhone") String parentsPhone, @RequestParam("file") MultipartFile multipartfile)
			throws IOException {
