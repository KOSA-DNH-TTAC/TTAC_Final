			...
			<div id="headerin">
				...
				<nav class="gnb">
					<ul>
						...
						<li class="menu last">
							<button class="btn_sumit ml" onclick="document.location.href='/bbs/logout.php';">로그아웃</button><button class="btn_sumit blbtn ml" onclick="document.location.href='/';">홈페이지</button>
						</li> <!--.menu.g1-->
