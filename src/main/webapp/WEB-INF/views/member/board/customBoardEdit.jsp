      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-12 entries">
            ...
            <article class="entry">
				<form action="/board/custom/${boardName}/${idx}/edit" method="POST" enctype="form-data">
					<div class="mb-3">
					...
					<button type="button" onclick="location.href='/board/custom/${boardName}/${idx}/delete'" style="width:130px; height:20; border-radius: 50px; padding:5px; border: none; background-color:#fd2c08; color:white; margin-top:10px; font-size: large;">삭제</button>
